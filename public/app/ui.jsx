...
var STORE_PALETTE = [
  { key: "indigo", label: "Indigo", ink: "#3d4bb0", soft: "#eceefb", line: "#c6cdf2", tint: "#fbfcff" },
  { key: "teal", label: "Teal", ink: "#0f766e", soft: "#e2f4f1", line: "#b2e0d9", tint: "#fafdfd" },
  { key: "amber", label: "Amber", ink: "#9a5b06", soft: "#fbeeda", line: "#efd3a6", tint: "#fefcf8" },
  { key: "rose", label: "Rose", ink: "#ad2f5f", soft: "#fbe9f0", line: "#f1c4d6", tint: "#fefbfc" },
  { key: "green", label: "Green", ink: "#2c7a30", soft: "#e7f4e8", line: "#bcdebe", tint: "#fafdfb" },
  { key: "violet", label: "Violet", ink: "#743bb0", soft: "#f2eafb", line: "#d9c3f1", tint: "#fdfbff" },
  { key: "slate", label: "Slate", ink: "#47546a", soft: "#eef1f5", line: "#cbd3df", tint: "#fcfdfe" },
  { key: "brown", label: "Brown", ink: "#835530", soft: "#f5ece3", line: "#dfc9b5", tint: "#fdfbf9" },
];
